...
class Settings(BaseSettings):
    ...
    DB_DISABLED: bool = os.getenv("DB_DISABLED", "False").lower() == "true"
    ...
    if IS_TESTING:
        ...
        if SUPABASE_PROJECT_REF and SUPABASE_DB_PASSWORD:
            ...
            POSTGRES_USER: str = os.getenv("DB_USER", "postgres") # Utiliser DB_USER
    ...
    LIVEKIT_HOST: Optional[str] = os.getenv("PUBLIC_LIVEKIT_URL")
